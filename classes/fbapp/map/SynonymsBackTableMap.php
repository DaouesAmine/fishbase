...
/**
 * This class defines the structure of the 'synonyms_back' table.
 *
 *
 *
 ...
 */
class SynonymsBackTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.SynonymsBackTableMap';
    ...
    {
        // attributes
        $this->setName('synonyms_back');
        $this->setPhpName('SynonymsBack');
        $this->setClassname('SynonymsBack');
        ...
        $this->addColumn('StatusOrder', 'Statusorder', 'FLOAT', false, null, 0);
