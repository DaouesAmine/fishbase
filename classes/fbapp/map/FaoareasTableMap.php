...
/**
 * This class defines the structure of the 'faoareas' table.
 *
 *
 *
 ...
 */
class FaoareasTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.FaoareasTableMap';
    ...
    {
        // attributes
        $this->setName('faoareas');
        $this->setPhpName('Faoareas');
        $this->setClassname('Faoareas');
