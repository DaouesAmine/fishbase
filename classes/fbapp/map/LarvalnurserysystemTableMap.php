...
/**
 * This class defines the structure of the 'larvalnurserysystem' table.
 *
 *
 *
 ...
 */
class LarvalnurserysystemTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.LarvalnurserysystemTableMap';
    ...
    {
        // attributes
        $this->setName('larvalnurserysystem');
        $this->setPhpName('Larvalnurserysystem');
        $this->setClassname('Larvalnurserysystem');
        ...
        $this->addColumn('NumberofLarvaeOrg', 'Numberoflarvaeorg', 'VARCHAR', false, 50, null);
        $this->addColumn('NumberofLarvae', 'Numberoflarvae', 'SMALLINT', false, null, null);
        ...
        $this->addColumn('IlluminationMin', 'Illuminationmin', 'FLOAT', false, null, null);
        $this->addColumn('IlluminationMax', 'Illuminationmax', 'FLOAT', false, null, null);
        $this->addColumn('StockingDensityOrg', 'Stockingdensityorg', 'VARCHAR', false, 50, null);
        $this->addColumn('StockingDensity', 'Stockingdensity', 'FLOAT', false, null, null);
        $this->addColumn('FirstFeedDaysMin', 'Firstfeeddaysmin', 'SMALLINT', false, null, null);
        $this->addColumn('FirstFeedDaysMax', 'Firstfeeddaysmax', 'SMALLINT', false, null, null);
        $this->addColumn('FirstFeedDaysDegMin', 'Firstfeeddaysdegmin', 'SMALLINT', false, null, null);
        $this->addColumn('FirstFeedDaysDegMax', 'Firstfeeddaysdegmax', 'SMALLINT', false, null, null);
        ...
        $this->addColumn('HatchingtoFryDaysMin', 'Hatchingtofrydaysmin', 'SMALLINT', false, null, null);
        $this->addColumn('HatchingtoFryDaysMax', 'Hatchingtofrydaysmax', 'SMALLINT', false, null, null);
        $this->addColumn('HatchingtoFryDaysDegMin', 'Hatchingtofrydaysdegmin', 'SMALLINT', false, null, null);
        $this->addColumn('HatchingtoFryDaysDegMax', 'Hatchingtofrydaysdegmax', 'SMALLINT', false, null, null);
        $this->addColumn('MortalityRate', 'Mortalityrate', 'VARCHAR', false, 50, null);
