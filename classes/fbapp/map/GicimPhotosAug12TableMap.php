...
/**
 * This class defines the structure of the 'gicim_photos_aug12' table.
 *
 *
 *
 ...
 */
class GicimPhotosAug12TableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.GicimPhotosAug12TableMap';
    ...
    {
        // attributes
        $this->setName('gicim_photos_aug12');
        $this->setPhpName('GicimPhotosAug12');
        $this->setClassname('GicimPhotosAug12');
