...
/**
 * This class defines the structure of the 'stocks' table.
 *
 *
 *
 ...
 */
class StocksTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.StocksTableMap';
    ...
    public function initialize()
    {
        // attributes
        $this->setName('stocks');
        $this->setPhpName('Stocks');
        $this->setClassname('Stocks');
        ...
        $this->addPrimaryKey('LocalUnique', 'Localunique', 'VARCHAR', true, 50, null);
        ...
        $this->addColumn('CITES_Code', 'CitesCode', 'VARCHAR', false, 13, null);
        $this->addColumn('CITES_Date', 'CitesDate', 'TIMESTAMP', false, null, null);
        $this->addColumn('CITES_Ref', 'CitesRef', 'INTEGER', false, null, null);
        $this->addColumn('CITES_Remarks', 'CitesRemarks', 'VARCHAR', false, 255, null);
        ...
        $this->addColumn('ICESStockID', 'Icesstockid', 'VARCHAR', false, 20, null);
        $this->addColumn('OsteoBaseID', 'Osteobaseid', 'INTEGER', false, null, null);
        $this->addColumn('DORIS_ID', 'DorisId', 'INTEGER', false, null, null);
        ...
        $this->addColumn('Fecundity', 'Fecundity', 'TINYINT', false, null, null);
