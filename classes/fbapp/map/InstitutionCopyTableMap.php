...
/**
 * This class defines the structure of the 'institution_copy' table.
 *
 *
 *
 ...
 */
class InstitutionCopyTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.InstitutionCopyTableMap';
    ...
    {
        // attributes
        $this->setName('institution_copy');
        $this->setPhpName('InstitutionCopy');
        $this->setClassname('InstitutionCopy');
