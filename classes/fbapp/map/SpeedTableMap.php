...
/**
 * This class defines the structure of the 'speed' table.
 *
 *
 *
 ...
 */
class SpeedTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.SpeedTableMap';
    ...
    public function initialize()
    {
        // attributes
        $this->setName('speed');
        $this->setPhpName('Speed');
        $this->setClassname('Speed');
        ...
        $this->addColumn('Length', 'Length', 'DOUBLE', false, 15, null);
        $this->addColumn('LengthType', 'Lengthtype', 'CHAR', false, 3, null);
        $this->addColumn('SpeedLS', 'Speedls', 'DOUBLE', false, 15, null);
        $this->addColumn('LengthTypeSpeed', 'Lengthtypespeed', 'VARCHAR', false, 5, null);
        $this->addColumn('Speedms', 'Speedms', 'DOUBLE', true, 15, null);
