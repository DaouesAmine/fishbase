...
/**
 * This class defines the structure of the 'gicim_photos_27_june_13_bak' table.
 *
 *
 *
 ...
 */
class GicimPhotos27June13BakTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.GicimPhotos27June13BakTableMap';
    ...
    {
        // attributes
        $this->setName('gicim_photos_27_june_13_bak');
        $this->setPhpName('GicimPhotos27June13Bak');
        $this->setClassname('GicimPhotos27June13Bak');
...
} // GicimPhotos27June13BakTableMap
