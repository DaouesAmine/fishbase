...
/**
 * This class defines the structure of the 'aquamaint' table.
 *
 *
 *
 ...
 */
class AquamaintTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.AquamaintTableMap';
    ...
    {
        // attributes
        $this->setName('aquamaint');
        $this->setPhpName('Aquamaint');
        $this->setClassname('Aquamaint');
        ...
        $this->addColumn('AquaMaintID', 'Aquamaintid', 'SMALLINT', false, null, null);
