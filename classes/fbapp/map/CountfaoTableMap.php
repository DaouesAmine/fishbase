...
/**
 * This class defines the structure of the 'countfao' table.
 *
 *
 *
 ...
 */
class CountfaoTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.CountfaoTableMap';
    ...
    {
        // attributes
        $this->setName('countfao');
        $this->setPhpName('Countfao');
        $this->setClassname('Countfao');
