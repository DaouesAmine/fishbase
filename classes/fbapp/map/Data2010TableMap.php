...
/**
 * This class defines the structure of the 'data2010' table.
 *
 *
 *
 ...
 */
class Data2010TableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'fbapp.map.Data2010TableMap';
    ...
    {
        // attributes
        $this->setName('data2010');
        $this->setPhpName('Data2010');
        $this->setClassname('Data2010');
