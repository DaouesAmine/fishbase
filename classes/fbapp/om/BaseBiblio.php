...
abstract class BaseBiblio extends BaseObject implements Persistent
{
    ...
    public function setAutoctr($v)
    {
        ...
        if ($this->autoctr !== $v) {
            $this->autoctr = $v;
            $this->modifiedColumns[] = BiblioPeer::AUTOCTR;
        }
    ...
    public function setRefno($v)
    {
        ...
        if ($this->refno !== $v) {
            $this->refno = $v;
            $this->modifiedColumns[] = BiblioPeer::REFNO;
        }
    ...
    public function setSpeccode($v)
    {
        ...
        if ($this->speccode !== $v) {
            $this->speccode = $v;
            $this->modifiedColumns[] = BiblioPeer::SPECCODE;
        }
    ...
    public function setSyncode($v)
    {
        ...
        if ($this->syncode !== $v) {
            $this->syncode = $v;
            $this->modifiedColumns[] = BiblioPeer::SYNCODE;
        }
    ...
    public function setRefpage($v)
    {
        ...
        if ($this->refpage !== $v) {
            $this->refpage = $v;
            $this->modifiedColumns[] = BiblioPeer::REFPAGE;
        }
    ...
    public function setPagefirst($v)
    {
        ...
        if ($this->pagefirst !== $v) {
            $this->pagefirst = $v;
            $this->modifiedColumns[] = BiblioPeer::PAGEFIRST;
        }
    ...
    public function setPageinsort($v)
    {
        ...
        if ($this->pageinsort !== $v) {
            $this->pageinsort = $v;
            $this->modifiedColumns[] = BiblioPeer::PAGEINSORT;
        }
    ...
    public function setLocality($v)
    {
        ...
        if ($this->locality !== $v) {
            $this->locality = $v;
            $this->modifiedColumns[] = BiblioPeer::LOCALITY;
        }
    ...
    public function setDistribution($v)
    {
        ...
        if ($this->distribution !== $v) {
            $this->distribution = $v;
            $this->modifiedColumns[] = BiblioPeer::DISTRIBUTION;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[] = BiblioPeer::COMMENT;
        }
    ...
    public function setQuote($v)
    {
        ...
        if ($this->quote !== $v) {
            $this->quote = $v;
            $this->modifiedColumns[] = BiblioPeer::QUOTE;
        }
    ...
    public function setEntered($v)
    {
        ...
        if ($this->entered !== $v) {
            $this->entered = $v;
            $this->modifiedColumns[] = BiblioPeer::ENTERED;
        }
    ...
    public function setDateentered($v)
    {
        ...
        if ($this->dateentered !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BiblioPeer::DATEENTERED;
            }
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[] = BiblioPeer::MODIFIED;
        }
    ...
    public function setDatemodified($v)
    {
        ...
        if ($this->datemodified !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BiblioPeer::DATEMODIFIED;
            }
        } // if either are not null
    ...
    public function setTs($v)
    {
        ...
        if ($this->ts !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BiblioPeer::TS;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->distribution = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->comment = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->quote = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            ...
            return $startcol + 16; // 16 = BiblioPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BiblioPeer::AUTOCTR)) {
            $modifiedColumns[':p' . $index++]  = '`autoctr`';
        }
        if ($this->isColumnModified(BiblioPeer::REFNO)) {
            $modifiedColumns[':p' . $index++]  = '`RefNo`';
        }
        if ($this->isColumnModified(BiblioPeer::SPECCODE)) {
            $modifiedColumns[':p' . $index++]  = '`SpecCode`';
        }
        if ($this->isColumnModified(BiblioPeer::SYNCODE)) {
            $modifiedColumns[':p' . $index++]  = '`SynCode`';
        }
        if ($this->isColumnModified(BiblioPeer::REFPAGE)) {
            $modifiedColumns[':p' . $index++]  = '`RefPage`';
        }
        if ($this->isColumnModified(BiblioPeer::PAGEFIRST)) {
            $modifiedColumns[':p' . $index++]  = '`PageFirst`';
        }
        if ($this->isColumnModified(BiblioPeer::PAGEINSORT)) {
            $modifiedColumns[':p' . $index++]  = '`PageInSort`';
        }
        if ($this->isColumnModified(BiblioPeer::LOCALITY)) {
            $modifiedColumns[':p' . $index++]  = '`Locality`';
        }
        if ($this->isColumnModified(BiblioPeer::DISTRIBUTION)) {
            $modifiedColumns[':p' . $index++]  = '`Distribution`';
        }
        if ($this->isColumnModified(BiblioPeer::COMMENT)) {
            $modifiedColumns[':p' . $index++]  = '`Comment`';
        }
        if ($this->isColumnModified(BiblioPeer::QUOTE)) {
            $modifiedColumns[':p' . $index++]  = '`Quote`';
        }
        if ($this->isColumnModified(BiblioPeer::ENTERED)) {
            $modifiedColumns[':p' . $index++]  = '`Entered`';
        }
        if ($this->isColumnModified(BiblioPeer::DATEENTERED)) {
            $modifiedColumns[':p' . $index++]  = '`DateEntered`';
        }
        if ($this->isColumnModified(BiblioPeer::MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = '`Modified`';
        }
        if ($this->isColumnModified(BiblioPeer::DATEMODIFIED)) {
            $modifiedColumns[':p' . $index++]  = '`DateModified`';
        }
        if ($this->isColumnModified(BiblioPeer::TS)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Biblio'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Biblio'][serialize($this->getPrimaryKey())] = true;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) $this->setDistribution($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setComment($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setQuote($arr[$keys[10]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BiblioPeer::AUTOCTR)) $criteria->add(BiblioPeer::AUTOCTR, $this->autoctr);
        if ($this->isColumnModified(BiblioPeer::REFNO)) $criteria->add(BiblioPeer::REFNO, $this->refno);
        if ($this->isColumnModified(BiblioPeer::SPECCODE)) $criteria->add(BiblioPeer::SPECCODE, $this->speccode);
        if ($this->isColumnModified(BiblioPeer::SYNCODE)) $criteria->add(BiblioPeer::SYNCODE, $this->syncode);
        if ($this->isColumnModified(BiblioPeer::REFPAGE)) $criteria->add(BiblioPeer::REFPAGE, $this->refpage);
        if ($this->isColumnModified(BiblioPeer::PAGEFIRST)) $criteria->add(BiblioPeer::PAGEFIRST, $this->pagefirst);
        if ($this->isColumnModified(BiblioPeer::PAGEINSORT)) $criteria->add(BiblioPeer::PAGEINSORT, $this->pageinsort);
        if ($this->isColumnModified(BiblioPeer::LOCALITY)) $criteria->add(BiblioPeer::LOCALITY, $this->locality);
        if ($this->isColumnModified(BiblioPeer::DISTRIBUTION)) $criteria->add(BiblioPeer::DISTRIBUTION, $this->distribution);
        if ($this->isColumnModified(BiblioPeer::COMMENT)) $criteria->add(BiblioPeer::COMMENT, $this->comment);
        if ($this->isColumnModified(BiblioPeer::QUOTE)) $criteria->add(BiblioPeer::QUOTE, $this->quote);
        if ($this->isColumnModified(BiblioPeer::ENTERED)) $criteria->add(BiblioPeer::ENTERED, $this->entered);
        if ($this->isColumnModified(BiblioPeer::DATEENTERED)) $criteria->add(BiblioPeer::DATEENTERED, $this->dateentered);
        if ($this->isColumnModified(BiblioPeer::MODIFIED)) $criteria->add(BiblioPeer::MODIFIED, $this->modified);
        if ($this->isColumnModified(BiblioPeer::DATEMODIFIED)) $criteria->add(BiblioPeer::DATEMODIFIED, $this->datemodified);
        if ($this->isColumnModified(BiblioPeer::TS)) $criteria->add(BiblioPeer::TS, $this->ts);
    ...
    {
        $criteria = new Criteria(BiblioPeer::DATABASE_NAME);
        $criteria->add(BiblioPeer::REFNO, $this->refno);
        $criteria->add(BiblioPeer::SPECCODE, $this->speccode);
        $criteria->add(BiblioPeer::SYNCODE, $this->syncode);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getRefno()) && (null === $this->getSpeccode()) && (null === $this->getSyncode());
    }
