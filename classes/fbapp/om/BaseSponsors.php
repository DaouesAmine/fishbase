...
abstract class BaseSponsors extends BaseObject implements Persistent
{
    ...
    public function setSponsorshipid($v)
    {
        ...
        if ($this->sponsorshipid !== $v) {
            ...
            $this->modifiedColumns[] = SponsorsPeer::SPONSORSHIPID;
        }
    ...
    public function setSponsorfor($v)
    {
        ...
        if ($this->sponsorfor !== $v) {
            $this->sponsorfor = $v;
            $this->modifiedColumns[] = SponsorsPeer::SPONSORFOR;
        }
    ...
    public function setSponsor($v)
    {
        ...
        if ($this->sponsor !== $v) {
            $this->sponsor = $v;
            $this->modifiedColumns[] = SponsorsPeer::SPONSOR;
        }
    ...
    public function setSponsortext($v)
    {
        ...
        if ($this->sponsortext !== $v) {
            $this->sponsortext = $v;
            $this->modifiedColumns[] = SponsorsPeer::SPONSORTEXT;
        }
    ...
    public function setPartnertype($v)
    {
        ...
        if ($this->partnertype !== $v) {
            $this->partnertype = $v;
            $this->modifiedColumns[] = SponsorsPeer::PARTNERTYPE;
        }
    ...
    public function setContactperson($v)
    {
        ...
        if ($this->contactperson !== $v) {
            ...
            $this->modifiedColumns[] = SponsorsPeer::CONTACTPERSON;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[] = SponsorsPeer::ADDRESS;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = SponsorsPeer::EMAIL;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[] = SponsorsPeer::URL;
        }
    ...
    public function setLogo($v)
    {
        ...
        if ($this->logo !== $v) {
            $this->logo = $v;
            $this->modifiedColumns[] = SponsorsPeer::LOGO;
        }
    ...
    public function setStartrent($v)
    {
        ...
        if ($this->startrent !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SponsorsPeer::STARTRENT;
            }
    ...
    public function setEndrent($v)
    {
        ...
        if ($this->endrent !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SponsorsPeer::ENDRENT;
            }
        } // if either are not null
    ...
    public function setCost($v)
    {
        ...
        if ($this->cost !== $v) {
            $this->cost = $v;
            $this->modifiedColumns[] = SponsorsPeer::COST;
        }
    ...
    public function setReceived($v)
    {
        ...
        if ($this->received !== $v) {
            $this->received = $v;
            $this->modifiedColumns[] = SponsorsPeer::RECEIVED;
        }
    ...
    public function setRemarks($v)
    {
        ...
        if ($this->remarks !== $v) {
            $this->remarks = $v;
            $this->modifiedColumns[] = SponsorsPeer::REMARKS;
        }
    ...
    public function setSpeccode($v)
    {
        ...
        if ($this->speccode !== $v) {
            $this->speccode = $v;
            $this->modifiedColumns[] = SponsorsPeer::SPECCODE;
        }
    ...
    public function setEntered($v)
    {
        ...
        if ($this->entered !== $v) {
            $this->entered = $v;
            $this->modifiedColumns[] = SponsorsPeer::ENTERED;
        }
    ...
    public function setDateentered($v)
    {
        ...
        if ($this->dateentered !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SponsorsPeer::DATEENTERED;
            }
        } // if either are not null
    ...
    public function setModified($v)
    {
        ...
        if ($this->modified !== $v) {
            $this->modified = $v;
            $this->modifiedColumns[] = SponsorsPeer::MODIFIED;
        }
    ...
    public function setDatemodified($v)
    {
        ...
        if ($this->datemodified !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SponsorsPeer::DATEMODIFIED;
            }
        } // if either are not null
    ...
    public function setExpert($v)
    {
        ...
        if ($this->expert !== $v) {
            $this->expert = $v;
            $this->modifiedColumns[] = SponsorsPeer::EXPERT;
        }
    ...
    public function setDatechecked($v)
    {
        ...
        if ($this->datechecked !== $v) {
            $this->datechecked = $v;
            $this->modifiedColumns[] = SponsorsPeer::DATECHECKED;
        }
    ...
    public function setTs($v)
    {
        ...
        if ($this->ts !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SponsorsPeer::TS;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 23; // 23 = SponsorsPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SponsorsPeer::SPONSORSHIPID)) {
            $modifiedColumns[':p' . $index++]  = '`SponsorshipID`';
        }
        if ($this->isColumnModified(SponsorsPeer::SPONSORFOR)) {
            $modifiedColumns[':p' . $index++]  = '`SponsorFor`';
        }
        if ($this->isColumnModified(SponsorsPeer::SPONSOR)) {
            $modifiedColumns[':p' . $index++]  = '`Sponsor`';
        }
        if ($this->isColumnModified(SponsorsPeer::SPONSORTEXT)) {
            $modifiedColumns[':p' . $index++]  = '`SponsorText`';
        }
        if ($this->isColumnModified(SponsorsPeer::PARTNERTYPE)) {
            $modifiedColumns[':p' . $index++]  = '`PartnerType`';
        }
        if ($this->isColumnModified(SponsorsPeer::CONTACTPERSON)) {
            $modifiedColumns[':p' . $index++]  = '`ContactPerson`';
        }
        if ($this->isColumnModified(SponsorsPeer::ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`Address`';
        }
        if ($this->isColumnModified(SponsorsPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`Email`';
        }
        if ($this->isColumnModified(SponsorsPeer::URL)) {
            $modifiedColumns[':p' . $index++]  = '`URL`';
        }
        if ($this->isColumnModified(SponsorsPeer::LOGO)) {
            $modifiedColumns[':p' . $index++]  = '`Logo`';
        }
        if ($this->isColumnModified(SponsorsPeer::STARTRENT)) {
            $modifiedColumns[':p' . $index++]  = '`StartRent`';
        }
        if ($this->isColumnModified(SponsorsPeer::ENDRENT)) {
            $modifiedColumns[':p' . $index++]  = '`EndRent`';
        }
        if ($this->isColumnModified(SponsorsPeer::COST)) {
            $modifiedColumns[':p' . $index++]  = '`Cost`';
        }
        if ($this->isColumnModified(SponsorsPeer::RECEIVED)) {
            $modifiedColumns[':p' . $index++]  = '`Received`';
        }
        if ($this->isColumnModified(SponsorsPeer::REMARKS)) {
            $modifiedColumns[':p' . $index++]  = '`Remarks`';
        }
        if ($this->isColumnModified(SponsorsPeer::SPECCODE)) {
            $modifiedColumns[':p' . $index++]  = '`SpecCode`';
        }
        if ($this->isColumnModified(SponsorsPeer::ENTERED)) {
            $modifiedColumns[':p' . $index++]  = '`Entered`';
        }
        if ($this->isColumnModified(SponsorsPeer::DATEENTERED)) {
            $modifiedColumns[':p' . $index++]  = '`DateEntered`';
        }
        if ($this->isColumnModified(SponsorsPeer::MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = '`Modified`';
        }
        if ($this->isColumnModified(SponsorsPeer::DATEMODIFIED)) {
            $modifiedColumns[':p' . $index++]  = '`DateModified`';
        }
        if ($this->isColumnModified(SponsorsPeer::EXPERT)) {
            $modifiedColumns[':p' . $index++]  = '`Expert`';
        }
        if ($this->isColumnModified(SponsorsPeer::DATECHECKED)) {
            $modifiedColumns[':p' . $index++]  = '`DateChecked`';
        }
        if ($this->isColumnModified(SponsorsPeer::TS)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Sponsors'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Sponsors'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SponsorsPeer::SPONSORSHIPID)) $criteria->add(SponsorsPeer::SPONSORSHIPID, $this->sponsorshipid);
        if ($this->isColumnModified(SponsorsPeer::SPONSORFOR)) $criteria->add(SponsorsPeer::SPONSORFOR, $this->sponsorfor);
        if ($this->isColumnModified(SponsorsPeer::SPONSOR)) $criteria->add(SponsorsPeer::SPONSOR, $this->sponsor);
        if ($this->isColumnModified(SponsorsPeer::SPONSORTEXT)) $criteria->add(SponsorsPeer::SPONSORTEXT, $this->sponsortext);
        if ($this->isColumnModified(SponsorsPeer::PARTNERTYPE)) $criteria->add(SponsorsPeer::PARTNERTYPE, $this->partnertype);
        if ($this->isColumnModified(SponsorsPeer::CONTACTPERSON)) $criteria->add(SponsorsPeer::CONTACTPERSON, $this->contactperson);
        if ($this->isColumnModified(SponsorsPeer::ADDRESS)) $criteria->add(SponsorsPeer::ADDRESS, $this->address);
        if ($this->isColumnModified(SponsorsPeer::EMAIL)) $criteria->add(SponsorsPeer::EMAIL, $this->email);
        if ($this->isColumnModified(SponsorsPeer::URL)) $criteria->add(SponsorsPeer::URL, $this->url);
        if ($this->isColumnModified(SponsorsPeer::LOGO)) $criteria->add(SponsorsPeer::LOGO, $this->logo);
        if ($this->isColumnModified(SponsorsPeer::STARTRENT)) $criteria->add(SponsorsPeer::STARTRENT, $this->startrent);
        if ($this->isColumnModified(SponsorsPeer::ENDRENT)) $criteria->add(SponsorsPeer::ENDRENT, $this->endrent);
        if ($this->isColumnModified(SponsorsPeer::COST)) $criteria->add(SponsorsPeer::COST, $this->cost);
        if ($this->isColumnModified(SponsorsPeer::RECEIVED)) $criteria->add(SponsorsPeer::RECEIVED, $this->received);
        if ($this->isColumnModified(SponsorsPeer::REMARKS)) $criteria->add(SponsorsPeer::REMARKS, $this->remarks);
        if ($this->isColumnModified(SponsorsPeer::SPECCODE)) $criteria->add(SponsorsPeer::SPECCODE, $this->speccode);
        if ($this->isColumnModified(SponsorsPeer::ENTERED)) $criteria->add(SponsorsPeer::ENTERED, $this->entered);
        if ($this->isColumnModified(SponsorsPeer::DATEENTERED)) $criteria->add(SponsorsPeer::DATEENTERED, $this->dateentered);
        if ($this->isColumnModified(SponsorsPeer::MODIFIED)) $criteria->add(SponsorsPeer::MODIFIED, $this->modified);
        if ($this->isColumnModified(SponsorsPeer::DATEMODIFIED)) $criteria->add(SponsorsPeer::DATEMODIFIED, $this->datemodified);
        if ($this->isColumnModified(SponsorsPeer::EXPERT)) $criteria->add(SponsorsPeer::EXPERT, $this->expert);
        if ($this->isColumnModified(SponsorsPeer::DATECHECKED)) $criteria->add(SponsorsPeer::DATECHECKED, $this->datechecked);
        if ($this->isColumnModified(SponsorsPeer::TS)) $criteria->add(SponsorsPeer::TS, $this->ts);
    ...
    {
        $criteria = new Criteria(SponsorsPeer::DATABASE_NAME);
        $criteria->add(SponsorsPeer::SPONSOR, $this->sponsor);
        $criteria->add(SponsorsPeer::SPECCODE, $this->speccode);
