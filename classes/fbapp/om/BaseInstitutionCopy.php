...
/**
 * Base class that represents a row from the 'institution_copy' table.
 *
 *
 *
 * @package    propel.generator.fbapp.om
 */
abstract class BaseInstitutionCopy extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'InstitutionCopyPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        InstitutionCopyPeer
     */
     ...
     * @return InstitutionCopy The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::ID;
        }
    ...
    public function setMainref($v)
    {
        ...
        if ($this->mainref !== $v) {
            $this->mainref = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::MAINREF;
        }
    ...
    public function setAcronym($v)
    {
        ...
        if ($this->acronym !== $v) {
            $this->acronym = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::ACRONYM;
        }
    ...
    public function setFullname($v)
    {
        ...
        if ($this->fullname !== $v) {
            $this->fullname = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::FULLNAME;
        }
    ...
    public function setSubjectarea($v)
    {
        ...
        if ($this->subjectarea !== $v) {
            $this->subjectarea = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::SUBJECTAREA;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::TYPE;
        }
    ...
    public function setOutreach($v)
    {
        ...
        if ($this->outreach !== $v) {
            $this->outreach = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::OUTREACH;
        }
    ...
    public function setEstablished($v)
    {
        ...
        if ($this->established !== $v) {
            $this->established = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::ESTABLISHED;
        }
    ...
    public function setEstablishingdate($v)
    {
        ...
        if ($this->establishingdate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = InstitutionCopyPeer::ESTABLISHINGDATE;
            }
    ...
    public function setEntryintoforcedate($v)
    {
        ...
        if ($this->entryintoforcedate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = InstitutionCopyPeer::ENTRYINTOFORCEDATE;
            }
        } // if either are not null
    ...
    public function setExpirydate($v)
    {
        ...
        if ($this->expirydate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = InstitutionCopyPeer::EXPIRYDATE;
            }
        } // if either are not null
    ...
    public function setLocalitycity($v)
    {
        ...
        if ($this->localitycity !== $v) {
            $this->localitycity = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::LOCALITYCITY;
        }
    ...
    public function setLocalitycountry($v)
    {
        ...
        if ($this->localitycountry !== $v) {
            ...
            $this->modifiedColumns[] = InstitutionCopyPeer::LOCALITYCOUNTRY;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::DESCRIPTION;
        }
    ...
    public function setRemarks($v)
    {
        ...
        if ($this->remarks !== $v) {
            $this->remarks = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::REMARKS;
        }
    ...
    public function setFulltext($v)
    {
        ...
        if ($this->fulltext !== $v) {
            $this->fulltext = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::FULLTEXT;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::ADDRESS;
        }
    ...
    public function setTelephone($v)
    {
        ...
        if ($this->telephone !== $v) {
            $this->telephone = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::TELEPHONE;
        }
    ...
    public function setFax($v)
    {
        ...
        if ($this->fax !== $v) {
            $this->fax = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::FAX;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::EMAIL;
        }
    ...
    public function setInternet($v)
    {
        ...
        if ($this->internet !== $v) {
            $this->internet = $v;
            $this->modifiedColumns[] = InstitutionCopyPeer::INTERNET;
        }
    ...
    public function setTs($v)
    {
        ...
        if ($this->ts !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = InstitutionCopyPeer::TS;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 22; // 22 = InstitutionCopyPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating InstitutionCopy object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = InstitutionCopyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = InstitutionCopyQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InstitutionCopyPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(InstitutionCopyPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::MAINREF)) {
            $modifiedColumns[':p' . $index++]  = '`MainRef`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::ACRONYM)) {
            $modifiedColumns[':p' . $index++]  = '`Acronym`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::FULLNAME)) {
            $modifiedColumns[':p' . $index++]  = '`FullName`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::SUBJECTAREA)) {
            $modifiedColumns[':p' . $index++]  = '`SubjectArea`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`Type`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::OUTREACH)) {
            $modifiedColumns[':p' . $index++]  = '`Outreach`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::ESTABLISHED)) {
            $modifiedColumns[':p' . $index++]  = '`Established`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::ESTABLISHINGDATE)) {
            $modifiedColumns[':p' . $index++]  = '`EstablishingDate`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::ENTRYINTOFORCEDATE)) {
            $modifiedColumns[':p' . $index++]  = '`EntryIntoForceDate`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::EXPIRYDATE)) {
            $modifiedColumns[':p' . $index++]  = '`ExpiryDate`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::LOCALITYCITY)) {
            $modifiedColumns[':p' . $index++]  = '`LocalityCity`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::LOCALITYCOUNTRY)) {
            $modifiedColumns[':p' . $index++]  = '`LocalityCountry`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`Description`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::REMARKS)) {
            $modifiedColumns[':p' . $index++]  = '`Remarks`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::FULLTEXT)) {
            $modifiedColumns[':p' . $index++]  = '`FullText`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`Address`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::TELEPHONE)) {
            $modifiedColumns[':p' . $index++]  = '`Telephone`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::FAX)) {
            $modifiedColumns[':p' . $index++]  = '`Fax`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`EMail`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::INTERNET)) {
            $modifiedColumns[':p' . $index++]  = '`Internet`';
        }
        if ($this->isColumnModified(InstitutionCopyPeer::TS)) {
            $modifiedColumns[':p' . $index++]  = '`TS`';
        }

        $sql = sprintf(
            'INSERT INTO `institution_copy` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = InstitutionCopyPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = InstitutionCopyPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['InstitutionCopy'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InstitutionCopy'][$this->getPrimaryKey()] = true;
        $keys = InstitutionCopyPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InstitutionCopyPeer::ID)) $criteria->add(InstitutionCopyPeer::ID, $this->id);
        if ($this->isColumnModified(InstitutionCopyPeer::MAINREF)) $criteria->add(InstitutionCopyPeer::MAINREF, $this->mainref);
        if ($this->isColumnModified(InstitutionCopyPeer::ACRONYM)) $criteria->add(InstitutionCopyPeer::ACRONYM, $this->acronym);
        if ($this->isColumnModified(InstitutionCopyPeer::FULLNAME)) $criteria->add(InstitutionCopyPeer::FULLNAME, $this->fullname);
        if ($this->isColumnModified(InstitutionCopyPeer::SUBJECTAREA)) $criteria->add(InstitutionCopyPeer::SUBJECTAREA, $this->subjectarea);
        if ($this->isColumnModified(InstitutionCopyPeer::TYPE)) $criteria->add(InstitutionCopyPeer::TYPE, $this->type);
        if ($this->isColumnModified(InstitutionCopyPeer::OUTREACH)) $criteria->add(InstitutionCopyPeer::OUTREACH, $this->outreach);
        if ($this->isColumnModified(InstitutionCopyPeer::ESTABLISHED)) $criteria->add(InstitutionCopyPeer::ESTABLISHED, $this->established);
        if ($this->isColumnModified(InstitutionCopyPeer::ESTABLISHINGDATE)) $criteria->add(InstitutionCopyPeer::ESTABLISHINGDATE, $this->establishingdate);
        if ($this->isColumnModified(InstitutionCopyPeer::ENTRYINTOFORCEDATE)) $criteria->add(InstitutionCopyPeer::ENTRYINTOFORCEDATE, $this->entryintoforcedate);
        if ($this->isColumnModified(InstitutionCopyPeer::EXPIRYDATE)) $criteria->add(InstitutionCopyPeer::EXPIRYDATE, $this->expirydate);
        if ($this->isColumnModified(InstitutionCopyPeer::LOCALITYCITY)) $criteria->add(InstitutionCopyPeer::LOCALITYCITY, $this->localitycity);
        if ($this->isColumnModified(InstitutionCopyPeer::LOCALITYCOUNTRY)) $criteria->add(InstitutionCopyPeer::LOCALITYCOUNTRY, $this->localitycountry);
        if ($this->isColumnModified(InstitutionCopyPeer::DESCRIPTION)) $criteria->add(InstitutionCopyPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(InstitutionCopyPeer::REMARKS)) $criteria->add(InstitutionCopyPeer::REMARKS, $this->remarks);
        if ($this->isColumnModified(InstitutionCopyPeer::FULLTEXT)) $criteria->add(InstitutionCopyPeer::FULLTEXT, $this->fulltext);
        if ($this->isColumnModified(InstitutionCopyPeer::ADDRESS)) $criteria->add(InstitutionCopyPeer::ADDRESS, $this->address);
        if ($this->isColumnModified(InstitutionCopyPeer::TELEPHONE)) $criteria->add(InstitutionCopyPeer::TELEPHONE, $this->telephone);
        if ($this->isColumnModified(InstitutionCopyPeer::FAX)) $criteria->add(InstitutionCopyPeer::FAX, $this->fax);
        if ($this->isColumnModified(InstitutionCopyPeer::EMAIL)) $criteria->add(InstitutionCopyPeer::EMAIL, $this->email);
        if ($this->isColumnModified(InstitutionCopyPeer::INTERNET)) $criteria->add(InstitutionCopyPeer::INTERNET, $this->internet);
        if ($this->isColumnModified(InstitutionCopyPeer::TS)) $criteria->add(InstitutionCopyPeer::TS, $this->ts);
    ...
    {
        $criteria = new Criteria(InstitutionCopyPeer::DATABASE_NAME);
        $criteria->add(InstitutionCopyPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of InstitutionCopy (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return InstitutionCopy Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return InstitutionCopyPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new InstitutionCopyPeer();
        }
    ...
    {
        return (string) $this->exportTo(InstitutionCopyPeer::DEFAULT_STRING_FORMAT);
    }
