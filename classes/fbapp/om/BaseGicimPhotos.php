...
/**
 * Base class that represents a row from the 'gicim_photos' table.
 *
 *
 *
 * @package    propel.generator.fbapp.om
 */
abstract class BaseGicimPhotos extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'GicimPhotosPeer';
     ...
     * @return GicimPhotos The current object (for fluent API support)
     */
    public function setUrlData($v)
    {
        ...
        if ($this->url_data !== $v) {
            $this->url_data = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::URL_DATA;
        }
    ...
    public function setImagepk($v)
    {
        ...
        if ($this->imagepk !== $v) {
            $this->imagepk = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::IMAGEPK;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::STATUS;
        }
    ...
    public function setTypeStatus($v)
    {
        ...
        if ($this->type_status !== $v) {
            $this->type_status = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::TYPE_STATUS;
        }
    ...
    public function setUrlimage($v)
    {
        ...
        if ($this->urlimage !== $v) {
            $this->urlimage = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::URLIMAGE;
        }
    ...
    public function setEtatdoc($v)
    {
        ...
        if ($this->etatdoc !== $v) {
            $this->etatdoc = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::ETATDOC;
        }
    ...
    public function setGicimimageid($v)
    {
        ...
        if ($this->gicimimageid !== $v) {
            $this->gicimimageid = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::GICIMIMAGEID;
        }
    ...
    public function setGicimpoissonsid($v)
    {
        ...
        if ($this->gicimpoissonsid !== $v) {
            ...
            $this->modifiedColumns[] = GicimPhotosPeer::GICIMPOISSONSID;
        }
    ...
    public function setFbsyncode($v)
    {
        ...
        if ($this->fbsyncode !== $v) {
            $this->fbsyncode = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::FBSYNCODE;
        }
    ...
    public function setFamille($v)
    {
        ...
        if ($this->famille !== $v) {
            $this->famille = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::FAMILLE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::NAME;
        }
    ...
    public function setAuthor($v)
    {
        ...
        if ($this->author !== $v) {
            $this->author = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::AUTHOR;
        }
    ...
    public function setCatalogNo($v)
    {
        ...
        if ($this->catalog_no !== $v) {
            $this->catalog_no = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::CATALOG_NO;
        }
    ...
    public function setCountry($v)
    {
        ...
        if ($this->country !== $v) {
            $this->country = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::COUNTRY;
        }
    ...
    public function setRegion($v)
    {
        ...
        if ($this->region !== $v) {
            $this->region = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::REGION;
        }
    ...
    public function setLocality($v)
    {
        ...
        if ($this->locality !== $v) {
            $this->locality = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::LOCALITY;
        }
    ...
    public function setCollector($v)
    {
        ...
        if ($this->collector !== $v) {
            $this->collector = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::COLLECTOR;
        }
    ...
    public function setDatecollected($v)
    {
        ...
        if ($this->datecollected !== $v) {
            ...
            $this->modifiedColumns[] = GicimPhotosPeer::DATECOLLECTED;
        }
    ...
    public function setYearcollected($v)
    {
        ...
        if ($this->yearcollected !== $v) {
            ...
            $this->modifiedColumns[] = GicimPhotosPeer::YEARCOLLECTED;
        }
    ...
    public function setObservations($v)
    {
        ...
        if ($this->observations !== $v) {
            $this->observations = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::OBSERVATIONS;
        }
    ...
    public function setMedium($v)
    {
        ...
        if ($this->medium !== $v) {
            $this->medium = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::MEDIUM;
        }
    ...
    public function setPaysadmin($v)
    {
        ...
        if ($this->paysadmin !== $v) {
            $this->paysadmin = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::PAYSADMIN;
        }
    ...
    public function setPkid($v)
    {
        ...
        if ($this->pkid !== $v) {
            $this->pkid = $v;
            $this->modifiedColumns[] = GicimPhotosPeer::PKID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 23; // 23 = GicimPhotosPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GicimPhotos object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GicimPhotosPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GicimPhotosQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GicimPhotosPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GicimPhotosPeer::URL_DATA)) {
            $modifiedColumns[':p' . $index++]  = '`URL_Data`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::IMAGEPK)) {
            $modifiedColumns[':p' . $index++]  = '`IMAGEPK`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`Status`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::TYPE_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`Type_status`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::URLIMAGE)) {
            $modifiedColumns[':p' . $index++]  = '`URLIMAGE`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::ETATDOC)) {
            $modifiedColumns[':p' . $index++]  = '`ETATDOC`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::GICIMIMAGEID)) {
            $modifiedColumns[':p' . $index++]  = '`GICIMimageID`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::GICIMPOISSONSID)) {
            $modifiedColumns[':p' . $index++]  = '`GicimPoissonsID`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::FBSYNCODE)) {
            $modifiedColumns[':p' . $index++]  = '`FBSYNCODE`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::FAMILLE)) {
            $modifiedColumns[':p' . $index++]  = '`FAMILLE`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`Name`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::AUTHOR)) {
            $modifiedColumns[':p' . $index++]  = '`Author`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::CATALOG_NO)) {
            $modifiedColumns[':p' . $index++]  = '`Catalog_no`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = '`Country`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::REGION)) {
            $modifiedColumns[':p' . $index++]  = '`REGION`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::LOCALITY)) {
            $modifiedColumns[':p' . $index++]  = '`Locality`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::COLLECTOR)) {
            $modifiedColumns[':p' . $index++]  = '`Collector`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::DATECOLLECTED)) {
            $modifiedColumns[':p' . $index++]  = '`Datecollected`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::YEARCOLLECTED)) {
            $modifiedColumns[':p' . $index++]  = '`Yearcollected`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::OBSERVATIONS)) {
            $modifiedColumns[':p' . $index++]  = '`OBSERVATIONS`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::MEDIUM)) {
            $modifiedColumns[':p' . $index++]  = '`Medium`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::PAYSADMIN)) {
            $modifiedColumns[':p' . $index++]  = '`PAYSADMIN`';
        }
        if ($this->isColumnModified(GicimPhotosPeer::PKID)) {
            $modifiedColumns[':p' . $index++]  = '`PKID`';
        }

        $sql = sprintf(
            'INSERT INTO `gicim_photos` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GicimPhotosPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GicimPhotosPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GicimPhotos'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GicimPhotos'][$this->getPrimaryKey()] = true;
        $keys = GicimPhotosPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GicimPhotosPeer::URL_DATA)) $criteria->add(GicimPhotosPeer::URL_DATA, $this->url_data);
        if ($this->isColumnModified(GicimPhotosPeer::IMAGEPK)) $criteria->add(GicimPhotosPeer::IMAGEPK, $this->imagepk);
        if ($this->isColumnModified(GicimPhotosPeer::STATUS)) $criteria->add(GicimPhotosPeer::STATUS, $this->status);
        if ($this->isColumnModified(GicimPhotosPeer::TYPE_STATUS)) $criteria->add(GicimPhotosPeer::TYPE_STATUS, $this->type_status);
        if ($this->isColumnModified(GicimPhotosPeer::URLIMAGE)) $criteria->add(GicimPhotosPeer::URLIMAGE, $this->urlimage);
        if ($this->isColumnModified(GicimPhotosPeer::ETATDOC)) $criteria->add(GicimPhotosPeer::ETATDOC, $this->etatdoc);
        if ($this->isColumnModified(GicimPhotosPeer::GICIMIMAGEID)) $criteria->add(GicimPhotosPeer::GICIMIMAGEID, $this->gicimimageid);
        if ($this->isColumnModified(GicimPhotosPeer::GICIMPOISSONSID)) $criteria->add(GicimPhotosPeer::GICIMPOISSONSID, $this->gicimpoissonsid);
        if ($this->isColumnModified(GicimPhotosPeer::FBSYNCODE)) $criteria->add(GicimPhotosPeer::FBSYNCODE, $this->fbsyncode);
        if ($this->isColumnModified(GicimPhotosPeer::FAMILLE)) $criteria->add(GicimPhotosPeer::FAMILLE, $this->famille);
        if ($this->isColumnModified(GicimPhotosPeer::NAME)) $criteria->add(GicimPhotosPeer::NAME, $this->name);
        if ($this->isColumnModified(GicimPhotosPeer::AUTHOR)) $criteria->add(GicimPhotosPeer::AUTHOR, $this->author);
        if ($this->isColumnModified(GicimPhotosPeer::CATALOG_NO)) $criteria->add(GicimPhotosPeer::CATALOG_NO, $this->catalog_no);
        if ($this->isColumnModified(GicimPhotosPeer::COUNTRY)) $criteria->add(GicimPhotosPeer::COUNTRY, $this->country);
        if ($this->isColumnModified(GicimPhotosPeer::REGION)) $criteria->add(GicimPhotosPeer::REGION, $this->region);
        if ($this->isColumnModified(GicimPhotosPeer::LOCALITY)) $criteria->add(GicimPhotosPeer::LOCALITY, $this->locality);
        if ($this->isColumnModified(GicimPhotosPeer::COLLECTOR)) $criteria->add(GicimPhotosPeer::COLLECTOR, $this->collector);
        if ($this->isColumnModified(GicimPhotosPeer::DATECOLLECTED)) $criteria->add(GicimPhotosPeer::DATECOLLECTED, $this->datecollected);
        if ($this->isColumnModified(GicimPhotosPeer::YEARCOLLECTED)) $criteria->add(GicimPhotosPeer::YEARCOLLECTED, $this->yearcollected);
        if ($this->isColumnModified(GicimPhotosPeer::OBSERVATIONS)) $criteria->add(GicimPhotosPeer::OBSERVATIONS, $this->observations);
        if ($this->isColumnModified(GicimPhotosPeer::MEDIUM)) $criteria->add(GicimPhotosPeer::MEDIUM, $this->medium);
        if ($this->isColumnModified(GicimPhotosPeer::PAYSADMIN)) $criteria->add(GicimPhotosPeer::PAYSADMIN, $this->paysadmin);
        if ($this->isColumnModified(GicimPhotosPeer::PKID)) $criteria->add(GicimPhotosPeer::PKID, $this->pkid);
    ...
    {
        $criteria = new Criteria(GicimPhotosPeer::DATABASE_NAME);
        $criteria->add(GicimPhotosPeer::PKID, $this->pkid);
     ...
     * objects.
     *
     * @param object $copyObj An object of GicimPhotos (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GicimPhotos Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GicimPhotosPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GicimPhotosPeer();
        }
    ...
    {
        return (string) $this->exportTo(GicimPhotosPeer::DEFAULT_STRING_FORMAT);
    }
