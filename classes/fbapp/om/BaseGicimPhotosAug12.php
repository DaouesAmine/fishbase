...
/**
 * Base class that represents a row from the 'gicim_photos_aug12' table.
 *
 *
 *
 * @package    propel.generator.fbapp.om
 */
abstract class BaseGicimPhotosAug12 extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'GicimPhotosAug12Peer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GicimPhotosAug12Peer
     */
     ...
     * @return GicimPhotosAug12 The current object (for fluent API support)
     */
    public function setUrlData($v)
    {
        ...
        if ($this->url_data !== $v) {
            $this->url_data = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::URL_DATA;
        }
    ...
    public function setImagepk($v)
    {
        ...
        if ($this->imagepk !== $v) {
            $this->imagepk = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::IMAGEPK;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::STATUS;
        }
    ...
    public function setTypeStatus($v)
    {
        ...
        if ($this->type_status !== $v) {
            $this->type_status = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::TYPE_STATUS;
        }
    ...
    public function setUrlimage($v)
    {
        ...
        if ($this->urlimage !== $v) {
            $this->urlimage = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::URLIMAGE;
        }
    ...
    public function setEtatdoc($v)
    {
        ...
        if ($this->etatdoc !== $v) {
            $this->etatdoc = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::ETATDOC;
        }
    ...
    public function setGicimimageid($v)
    {
        ...
        if ($this->gicimimageid !== $v) {
            $this->gicimimageid = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::GICIMIMAGEID;
        }
    ...
    public function setGicimpoissonsid($v)
    {
        ...
        if ($this->gicimpoissonsid !== $v) {
            ...
            $this->modifiedColumns[] = GicimPhotosAug12Peer::GICIMPOISSONSID;
        }
    ...
    public function setFbsyncode($v)
    {
        ...
        if ($this->fbsyncode !== $v) {
            $this->fbsyncode = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::FBSYNCODE;
        }
    ...
    public function setFamille($v)
    {
        ...
        if ($this->famille !== $v) {
            $this->famille = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::FAMILLE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::NAME;
        }
    ...
    public function setAuthor($v)
    {
        ...
        if ($this->author !== $v) {
            $this->author = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::AUTHOR;
        }
    ...
    public function setCatalogNo($v)
    {
        ...
        if ($this->catalog_no !== $v) {
            $this->catalog_no = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::CATALOG_NO;
        }
    ...
    public function setCountry($v)
    {
        ...
        if ($this->country !== $v) {
            $this->country = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::COUNTRY;
        }
    ...
    public function setRegion($v)
    {
        ...
        if ($this->region !== $v) {
            $this->region = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::REGION;
        }
    ...
    public function setLocality($v)
    {
        ...
        if ($this->locality !== $v) {
            $this->locality = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::LOCALITY;
        }
    ...
    public function setCollector($v)
    {
        ...
        if ($this->collector !== $v) {
            $this->collector = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::COLLECTOR;
        }
    ...
    public function setDatecollected($v)
    {
        ...
        if ($this->datecollected !== $v) {
            ...
            $this->modifiedColumns[] = GicimPhotosAug12Peer::DATECOLLECTED;
        }
    ...
    public function setYearcollected($v)
    {
        ...
        if ($this->yearcollected !== $v) {
            ...
            $this->modifiedColumns[] = GicimPhotosAug12Peer::YEARCOLLECTED;
        }
    ...
    public function setObservations($v)
    {
        ...
        if ($this->observations !== $v) {
            $this->observations = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::OBSERVATIONS;
        }
    ...
    public function setMedium($v)
    {
        ...
        if ($this->medium !== $v) {
            $this->medium = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::MEDIUM;
        }
    ...
    public function setPaysadmin($v)
    {
        ...
        if ($this->paysadmin !== $v) {
            $this->paysadmin = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::PAYSADMIN;
        }
    ...
    public function setPkid($v)
    {
        ...
        if ($this->pkid !== $v) {
            $this->pkid = $v;
            $this->modifiedColumns[] = GicimPhotosAug12Peer::PKID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 23; // 23 = GicimPhotosAug12Peer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GicimPhotosAug12 object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GicimPhotosAug12Peer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GicimPhotosAug12Query::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GicimPhotosAug12Peer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GicimPhotosAug12Peer::URL_DATA)) {
            $modifiedColumns[':p' . $index++]  = '`URL_Data`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::IMAGEPK)) {
            $modifiedColumns[':p' . $index++]  = '`IMAGEPK`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`Status`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::TYPE_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`Type_status`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::URLIMAGE)) {
            $modifiedColumns[':p' . $index++]  = '`URLIMAGE`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::ETATDOC)) {
            $modifiedColumns[':p' . $index++]  = '`ETATDOC`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::GICIMIMAGEID)) {
            $modifiedColumns[':p' . $index++]  = '`GICIMimageID`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::GICIMPOISSONSID)) {
            $modifiedColumns[':p' . $index++]  = '`GicimPoissonsID`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::FBSYNCODE)) {
            $modifiedColumns[':p' . $index++]  = '`FBSYNCODE`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::FAMILLE)) {
            $modifiedColumns[':p' . $index++]  = '`FAMILLE`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`Name`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::AUTHOR)) {
            $modifiedColumns[':p' . $index++]  = '`Author`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::CATALOG_NO)) {
            $modifiedColumns[':p' . $index++]  = '`Catalog_no`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = '`Country`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::REGION)) {
            $modifiedColumns[':p' . $index++]  = '`REGION`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::LOCALITY)) {
            $modifiedColumns[':p' . $index++]  = '`Locality`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::COLLECTOR)) {
            $modifiedColumns[':p' . $index++]  = '`Collector`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::DATECOLLECTED)) {
            $modifiedColumns[':p' . $index++]  = '`Datecollected`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::YEARCOLLECTED)) {
            $modifiedColumns[':p' . $index++]  = '`Yearcollected`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::OBSERVATIONS)) {
            $modifiedColumns[':p' . $index++]  = '`OBSERVATIONS`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::MEDIUM)) {
            $modifiedColumns[':p' . $index++]  = '`Medium`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::PAYSADMIN)) {
            $modifiedColumns[':p' . $index++]  = '`PAYSADMIN`';
        }
        if ($this->isColumnModified(GicimPhotosAug12Peer::PKID)) {
            $modifiedColumns[':p' . $index++]  = '`PKID`';
        }

        $sql = sprintf(
            'INSERT INTO `gicim_photos_aug12` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GicimPhotosAug12Peer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GicimPhotosAug12Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GicimPhotosAug12'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GicimPhotosAug12'][$this->getPrimaryKey()] = true;
        $keys = GicimPhotosAug12Peer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GicimPhotosAug12Peer::URL_DATA)) $criteria->add(GicimPhotosAug12Peer::URL_DATA, $this->url_data);
        if ($this->isColumnModified(GicimPhotosAug12Peer::IMAGEPK)) $criteria->add(GicimPhotosAug12Peer::IMAGEPK, $this->imagepk);
        if ($this->isColumnModified(GicimPhotosAug12Peer::STATUS)) $criteria->add(GicimPhotosAug12Peer::STATUS, $this->status);
        if ($this->isColumnModified(GicimPhotosAug12Peer::TYPE_STATUS)) $criteria->add(GicimPhotosAug12Peer::TYPE_STATUS, $this->type_status);
        if ($this->isColumnModified(GicimPhotosAug12Peer::URLIMAGE)) $criteria->add(GicimPhotosAug12Peer::URLIMAGE, $this->urlimage);
        if ($this->isColumnModified(GicimPhotosAug12Peer::ETATDOC)) $criteria->add(GicimPhotosAug12Peer::ETATDOC, $this->etatdoc);
        if ($this->isColumnModified(GicimPhotosAug12Peer::GICIMIMAGEID)) $criteria->add(GicimPhotosAug12Peer::GICIMIMAGEID, $this->gicimimageid);
        if ($this->isColumnModified(GicimPhotosAug12Peer::GICIMPOISSONSID)) $criteria->add(GicimPhotosAug12Peer::GICIMPOISSONSID, $this->gicimpoissonsid);
        if ($this->isColumnModified(GicimPhotosAug12Peer::FBSYNCODE)) $criteria->add(GicimPhotosAug12Peer::FBSYNCODE, $this->fbsyncode);
        if ($this->isColumnModified(GicimPhotosAug12Peer::FAMILLE)) $criteria->add(GicimPhotosAug12Peer::FAMILLE, $this->famille);
        if ($this->isColumnModified(GicimPhotosAug12Peer::NAME)) $criteria->add(GicimPhotosAug12Peer::NAME, $this->name);
        if ($this->isColumnModified(GicimPhotosAug12Peer::AUTHOR)) $criteria->add(GicimPhotosAug12Peer::AUTHOR, $this->author);
        if ($this->isColumnModified(GicimPhotosAug12Peer::CATALOG_NO)) $criteria->add(GicimPhotosAug12Peer::CATALOG_NO, $this->catalog_no);
        if ($this->isColumnModified(GicimPhotosAug12Peer::COUNTRY)) $criteria->add(GicimPhotosAug12Peer::COUNTRY, $this->country);
        if ($this->isColumnModified(GicimPhotosAug12Peer::REGION)) $criteria->add(GicimPhotosAug12Peer::REGION, $this->region);
        if ($this->isColumnModified(GicimPhotosAug12Peer::LOCALITY)) $criteria->add(GicimPhotosAug12Peer::LOCALITY, $this->locality);
        if ($this->isColumnModified(GicimPhotosAug12Peer::COLLECTOR)) $criteria->add(GicimPhotosAug12Peer::COLLECTOR, $this->collector);
        if ($this->isColumnModified(GicimPhotosAug12Peer::DATECOLLECTED)) $criteria->add(GicimPhotosAug12Peer::DATECOLLECTED, $this->datecollected);
        if ($this->isColumnModified(GicimPhotosAug12Peer::YEARCOLLECTED)) $criteria->add(GicimPhotosAug12Peer::YEARCOLLECTED, $this->yearcollected);
        if ($this->isColumnModified(GicimPhotosAug12Peer::OBSERVATIONS)) $criteria->add(GicimPhotosAug12Peer::OBSERVATIONS, $this->observations);
        if ($this->isColumnModified(GicimPhotosAug12Peer::MEDIUM)) $criteria->add(GicimPhotosAug12Peer::MEDIUM, $this->medium);
        if ($this->isColumnModified(GicimPhotosAug12Peer::PAYSADMIN)) $criteria->add(GicimPhotosAug12Peer::PAYSADMIN, $this->paysadmin);
        if ($this->isColumnModified(GicimPhotosAug12Peer::PKID)) $criteria->add(GicimPhotosAug12Peer::PKID, $this->pkid);
    ...
    {
        $criteria = new Criteria(GicimPhotosAug12Peer::DATABASE_NAME);
        $criteria->add(GicimPhotosAug12Peer::PKID, $this->pkid);
     ...
     * objects.
     *
     * @param object $copyObj An object of GicimPhotosAug12 (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GicimPhotosAug12 Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GicimPhotosAug12Peer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GicimPhotosAug12Peer();
        }
    ...
    {
        return (string) $this->exportTo(GicimPhotosAug12Peer::DEFAULT_STRING_FORMAT);
    }
